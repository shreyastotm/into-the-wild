...
CREATE TABLE IF NOT EXISTS "public"."ad_hoc_expense_shares" (
...
ALTER TABLE "public"."ad_hoc_expense_shares" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."expense_sharing" (
...
ALTER TABLE "public"."expense_sharing" OWNER TO "postgres";
...
ALTER TABLE "public"."expense_sharing_expense_id_seq" OWNER TO "postgres";
...
ALTER TABLE "public"."logistics_logistics_id_seq" OWNER TO "postgres";
...
ALTER TABLE "public"."packing_list_items" OWNER TO "postgres";
...
ALTER TABLE "public"."packing_list_templates" OWNER TO "postgres";
...
ALTER TABLE "public"."roles_assignments" OWNER TO "postgres";
...
ALTER TABLE "public"."roles_assignments_role_id_seq" OWNER TO "postgres";
...
ALTER TABLE "public"."trek_packing_lists" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."user_expense_penalties" (
...
ALTER TABLE "public"."user_expense_penalties" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."expense_sharing" ALTER COLUMN "expense_id" SET DEFAULT "nextval"('"public"."expense_sharing_expense_id_seq"'::"regclass");



ALTER TABLE ONLY "public"."logistics" ALTER COLUMN "logistics_id" SET DEFAULT "nextval"('"public"."logistics_logistics_id_seq"'::"regclass");



ALTER TABLE ONLY "public"."packing_items" ALTER COLUMN "item_id" SET DEFAULT "nextval"('"public"."packing_items_item_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."roles_assignments" ALTER COLUMN "role_id" SET DEFAULT "nextval"('"public"."roles_assignments_role_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."ad_hoc_expense_shares"
...
ALTER TABLE ONLY "public"."expense_sharing"
    ADD CONSTRAINT "expense_sharing_pkey" PRIMARY KEY ("expense_id");



ALTER TABLE ONLY "public"."logistics"
    ADD CONSTRAINT "logistics_pkey" PRIMARY KEY ("logistics_id");
...
ALTER TABLE ONLY "public"."packing_list_items"
    ADD CONSTRAINT "packing_list_items_pkey" PRIMARY KEY ("item_id");



ALTER TABLE ONLY "public"."packing_list_templates"
    ADD CONSTRAINT "packing_list_templates_pkey" PRIMARY KEY ("template_id");
...
ALTER TABLE ONLY "public"."roles_assignments"
    ADD CONSTRAINT "roles_assignments_pkey" PRIMARY KEY ("role_id");
...
ALTER TABLE ONLY "public"."trek_packing_lists"
    ADD CONSTRAINT "trek_packing_lists_pkey" PRIMARY KEY ("trek_id", "template_id");



ALTER TABLE ONLY "public"."user_expense_penalties"
    ADD CONSTRAINT "user_expense_penalties_pkey" PRIMARY KEY ("penalty_id");
...
ALTER TABLE ONLY "public"."expense_sharing"
    ADD CONSTRAINT "expense_sharing_trek_id_fkey" FOREIGN KEY ("trek_id") REFERENCES "public"."trek_events"("trek_id");



ALTER TABLE ONLY "public"."logistics"
    ADD CONSTRAINT "logistics_trek_id_fkey" FOREIGN KEY ("trek_id") REFERENCES "public"."trek_events"("trek_id");



ALTER TABLE ONLY "public"."packing_list_items"
    ADD CONSTRAINT "packing_list_items_template_id_fkey" FOREIGN KEY ("template_id") REFERENCES "public"."packing_list_templates"("template_id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."packing_list_templates"
    ADD CONSTRAINT "packing_list_templates_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."profiles"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."registrations"
    ADD CONSTRAINT "registrations_trek_id_fkey" FOREIGN KEY ("trek_id") REFERENCES "public"."trek_events"("trek_id");



ALTER TABLE ONLY "public"."roles_assignments"
    ADD CONSTRAINT "roles_assignments_trek_id_fkey" FOREIGN KEY ("trek_id") REFERENCES "public"."trek_events"("trek_id");
...
ALTER TABLE ONLY "public"."trek_expenses"
    ADD CONSTRAINT "trek_expenses_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."profiles"("id");
...
ALTER TABLE ONLY "public"."trek_packing_lists"
    ADD CONSTRAINT "trek_packing_lists_template_id_fkey" FOREIGN KEY ("template_id") REFERENCES "public"."packing_list_templates"("template_id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."trek_packing_lists"
    ADD CONSTRAINT "trek_packing_lists_trek_id_fkey" FOREIGN KEY ("trek_id") REFERENCES "public"."trek_events"("trek_id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."user_expense_penalties"
    ADD CONSTRAINT "user_expense_penalties_trek_id_fkey" FOREIGN KEY ("trek_id") REFERENCES "public"."trek_events"("trek_id");
...
CREATE POLICY "Allow delete for authenticated users" ON "public"."packing_items" FOR DELETE TO "authenticated" USING (true);
...
CREATE POLICY "Allow insert for authenticated users" ON "public"."packing_items" FOR INSERT TO "authenticated" WITH CHECK (true);
...
CREATE POLICY "Allow select for authenticated users" ON "public"."packing_items" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Allow select for authenticated users on packing_items" ON "public"."packing_items" FOR SELECT USING (("auth"."uid"() IS NOT NULL));
...
CREATE POLICY "Allow update for authenticated users" ON "public"."packing_items" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "Expense creator can create expense shares" ON "public"."ad_hoc_expense_shares" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
...
CREATE POLICY "Expense creator can delete expense shares" ON "public"."ad_hoc_expense_shares" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."trek_ad_hoc_expenses"
  WHERE (("trek_ad_hoc_expenses"."expense_id" = "ad_hoc_expense_shares"."expense_id") AND ("trek_ad_hoc_expenses"."payer_id" = (("auth"."uid"())::"text")::integer)))));



CREATE POLICY "Only administrators can create penalties" ON "public"."user_expense_penalties" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."roles_assignments"
  WHERE (("roles_assignments"."user_id" = (("auth"."uid"())::"text")::integer) AND ("roles_assignments"."role_type" = 'trek_lead'::"public"."role_type")))));



CREATE POLICY "Only administrators can delete admin approved expenses" ON "public"."trek_admin_approved_expenses" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."roles_assignments"
  WHERE (("roles_assignments"."user_id" = (("auth"."uid"())::"text")::integer) AND ("roles_assignments"."role_type" = 'trek_lead'::"public"."role_type")))));



CREATE POLICY "Only administrators can delete penalties" ON "public"."user_expense_penalties" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."roles_assignments"
  WHERE (("roles_assignments"."user_id" = (("auth"."uid"())::"text")::integer) AND ("roles_assignments"."role_type" = 'trek_lead'::"public"."role_type")))));



CREATE POLICY "Only administrators can delete trek fixed expenses" ON "public"."trek_fixed_expenses" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."roles_assignments"
  WHERE (("roles_assignments"."user_id" = (("auth"."uid"())::"text")::integer) AND ("roles_assignments"."role_type" = 'trek_lead'::"public"."role_type")))));



CREATE POLICY "Only administrators can insert trek fixed expenses" ON "public"."trek_fixed_expenses" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."roles_assignments"
  WHERE (("roles_assignments"."user_id" = (("auth"."uid"())::"text")::integer) AND ("roles_assignments"."role_type" = 'trek_lead'::"public"."role_type")))));



CREATE POLICY "Only administrators can update admin approved expenses" ON "public"."trek_admin_approved_expenses" FOR UPDATE TO "authenticated" USING (((EXISTS ( SELECT 1
   FROM "public"."roles_assignments"
  WHERE (("roles_assignments"."user_id" = (("auth"."uid"())::"text")::integer) AND ("roles_assignments"."role_type" = 'trek_lead'::"public"."role_type")))) OR ((("auth"."uid"())::"text")::integer = "requested_by")));



CREATE POLICY "Only administrators can update penalties" ON "public"."user_expense_penalties" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."roles_assignments"
  WHERE (("roles_assignments"."user_id" = (("auth"."uid"())::"text")::integer) AND ("roles_assignments"."role_type" = 'trek_lead'::"public"."role_type")))));



CREATE POLICY "Only administrators can update trek fixed expenses" ON "public"."trek_fixed_expenses" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."roles_assignments"
  WHERE (("roles_assignments"."user_id" = (("auth"."uid"())::"text")::integer) AND ("roles_assignments"."role_type" = 'trek_lead'::"public"."role_type")))));
...
CREATE POLICY "Users can update their own expense share responses" ON "public"."ad_hoc_expense_shares" FOR UPDATE TO "authenticated" USING ((((("auth"."uid"())::"text")::integer = "user_id") OR (EXISTS ( SELECT 1
   FROM "public"."trek_ad_hoc_expenses"
  WHERE (("trek_ad_hoc_expenses"."expense_id" = "ad_hoc_expense_shares"."expense_id") AND ("trek_ad_hoc_expenses"."payer_id" = (("auth"."uid"())::"text")::integer))))));
...
CREATE POLICY "Users can view expense shares they are part of" ON "public"."ad_hoc_expense_shares" FOR SELECT TO "authenticated" USING ((((("auth"."uid"())::"text")::integer = "user_id") OR (EXISTS ( SELECT 1
   FROM "public"."trek_ad_hoc_expenses"
  WHERE (("trek_ad_hoc_expenses"."expense_id" = "ad_hoc_expense_shares"."expense_id") AND ("trek_ad_hoc_expenses"."payer_id" = (("auth"."uid"())::"text")::integer))))));



CREATE POLICY "Users can view their own penalties" ON "public"."user_expense_penalties" FOR SELECT TO "authenticated" USING (((("auth"."uid"())::"text")::integer = "user_id"));
...
GRANT ALL ON TABLE "public"."ad_hoc_expense_shares" TO "anon";
GRANT ALL ON TABLE "public"."ad_hoc_expense_shares" TO "authenticated";
GRANT ALL ON TABLE "public"."ad_hoc_expense_shares" TO "service_role";
...
GRANT ALL ON TABLE "public"."expense_sharing" TO "anon";
GRANT ALL ON TABLE "public"."expense_sharing" TO "authenticated";
GRANT ALL ON TABLE "public"."expense_sharing" TO "service_role";



GRANT ALL ON SEQUENCE "public"."expense_sharing_expense_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."expense_sharing_expense_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."expense_sharing_expense_id_seq" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."logistics_logistics_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."logistics_logistics_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."logistics_logistics_id_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."packing_list_items" TO "anon";
GRANT ALL ON TABLE "public"."packing_list_items" TO "authenticated";
GRANT ALL ON TABLE "public"."packing_list_items" TO "service_role";



GRANT ALL ON TABLE "public"."packing_list_templates" TO "anon";
GRANT ALL ON TABLE "public"."packing_list_templates" TO "authenticated";
GRANT ALL ON TABLE "public"."packing_list_templates" TO "service_role";
...
GRANT ALL ON TABLE "public"."roles_assignments" TO "anon";
GRANT ALL ON TABLE "public"."roles_assignments" TO "authenticated";
GRANT ALL ON TABLE "public"."roles_assignments" TO "service_role";



GRANT ALL ON SEQUENCE "public"."roles_assignments_role_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."roles_assignments_role_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."roles_assignments_role_id_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."trek_packing_lists" TO "anon";
GRANT ALL ON TABLE "public"."trek_packing_lists" TO "authenticated";
GRANT ALL ON TABLE "public"."trek_packing_lists" TO "service_role";



GRANT ALL ON TABLE "public"."user_expense_penalties" TO "anon";
GRANT ALL ON TABLE "public"."user_expense_penalties" TO "authenticated";
GRANT ALL ON TABLE "public"."user_expense_penalties" TO "service_role";
