...
ALTER TABLE "public"."roles_assignments" ALTER COLUMN "role_id" ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME "public"."roles_assignments_role_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE INDEX "idx_registrations_trek_id" ON "public"."registrations" USING "btree" ("trek_id");
...
CREATE INDEX "idx_roles_assignments_user_id_role_type" ON "public"."roles_assignments" USING "btree" ("user_id", "role_type");
...
CREATE POLICY "Admins can manage all registrations" ON "public"."registrations" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."users"
...
CREATE POLICY "Allow all deletes" ON "public"."trek_packing_lists" FOR DELETE USING (true);
...
CREATE POLICY "Only trek_lead can delete internal events" ON "public"."trek_events" FOR DELETE TO "authenticated" USING ((("event_creator_type" = 'internal'::"public"."event_creator_type") AND (EXISTS ( SELECT 1
   FROM "public"."roles_assignments" "r"
  WHERE (("r"."user_id" = "auth"."uid"()) AND ("r"."role_type" = 'trek_lead'::"public"."role_type"))))));



CREATE POLICY "Only trek_lead can insert internal events" ON "public"."trek_events" FOR INSERT TO "authenticated" WITH CHECK ((("event_creator_type" = 'internal'::"public"."event_creator_type") AND (EXISTS ( SELECT 1
   FROM "public"."roles_assignments" "r"
  WHERE (("r"."user_id" = "auth"."uid"()) AND ("r"."role_type" = 'trek_lead'::"public"."role_type"))))));



CREATE POLICY "Only trek_lead can update internal events" ON "public"."trek_events" FOR UPDATE TO "authenticated" USING ((("event_creator_type" = 'internal'::"public"."event_creator_type") AND (EXISTS ( SELECT 1
   FROM "public"."roles_assignments" "r"
  WHERE (("r"."user_id" = "auth"."uid"()) AND ("r"."role_type" = 'trek_lead'::"public"."role_type"))))));
...
CREATE POLICY "Users can register for treks" ON "public"."registrations" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can view their registrations" ON "public"."registrations" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "trek_lead can delete all trek_events" ON "public"."trek_events" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."roles_assignments" "r"
  WHERE (("r"."user_id" = "auth"."uid"()) AND ("r"."role_type" = 'trek_lead'::"public"."role_type")))));



CREATE POLICY "trek_lead can insert all trek_events" ON "public"."trek_events" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."roles_assignments" "r"
  WHERE (("r"."user_id" = "auth"."uid"()) AND ("r"."role_type" = 'trek_lead'::"public"."role_type")))));



CREATE POLICY "trek_lead can select all trek_events" ON "public"."trek_events" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."roles_assignments" "r"
  WHERE (("r"."user_id" = "auth"."uid"()) AND ("r"."role_type" = 'trek_lead'::"public"."role_type")))));



CREATE POLICY "trek_lead can update all trek_events" ON "public"."trek_events" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."roles_assignments" "r"
  WHERE (("r"."user_id" = "auth"."uid"()) AND ("r"."role_type" = 'trek_lead'::"public"."role_type")))));
