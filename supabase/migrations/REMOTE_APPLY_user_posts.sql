-- ====================================================================
-- ADD USER POSTS AND POST REACTIONS TABLES (FOR REMOTE DATABASE)
-- ====================================================================
-- Apply this SQL directly in Supabase SQL Editor if migration push fails
-- Includes user_connections table if it doesn't exist (required dependency)
-- ====================================================================

BEGIN;

-- First, ensure user_connections table exists (required for RLS policy)
...
-- Create RLS policies for user_connections (drop first to avoid conflicts)
...
-- Create RLS policies for user_posts (drop first to avoid conflicts)
