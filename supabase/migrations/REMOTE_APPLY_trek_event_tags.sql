...
-- Apply directly via Supabase SQL Editor
-- Created: 2025-01-15
...
DROP POLICY IF EXISTS "Everyone can view active tags" ON public.trek_event_tags;
CREATE POLICY "Everyone can view active tags" ON public.trek_event_tags
    FOR SELECT USING (is_active = true);

DROP POLICY IF EXISTS "Admins can manage tags" ON public.trek_event_tags;
...
DROP POLICY IF EXISTS "Everyone can view tag assignments" ON public.trek_event_tag_assignments;
CREATE POLICY "Everyone can view tag assignments" ON public.trek_event_tag_assignments
    FOR SELECT USING (true);

DROP POLICY IF EXISTS "Admins can manage tag assignments" ON public.trek_event_tag_assignments;
