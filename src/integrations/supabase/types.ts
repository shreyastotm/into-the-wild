...
export type Database = {
  public: {
    Tables: {
      ...
      logistics: {
        Row: {
          additional_vendor_info: Json | null
          computed_pickup_route: Json | null
          created_at: string | null
          logistics_id: number
          trek_id: number
          user_starting_locations: Json | null
        }
        Insert: {
          additional_vendor_info?: Json | null
          computed_pickup_route?: Json | null
        ...
        Relationships: [
          {
            foreignKeyName: "logistics_trek_id_fkey"
            columns: ["trek_id"]
            isOneToOne: false
            referencedRelation: "trek_events"
            referencedColumns: ["trek_id"]
      ...
      partners: {
        Row: {
          ...
          created_at: string | null
          external_portal_details: Json | null
          partner_id: number
          partner_name: string
          revenue_sharing_rate: number | null
          updated_at: string | null
      ...
      registrations: {
        ...
        Relationships: [
          {
            foreignKeyName: "registrations_trek_id_fkey"
            columns: ["trek_id"]
            isOneToOne: false
            referencedRelation: "trek_events"
            referencedColumns: ["trek_id"]
      ...
      roles_assignments: {
        Row: {
          ...
          community_vote_score: number | null
          created_at: string | null
          role_id: number
        ...
        Relationships: [
          {
            foreignKeyName: "roles_assignments_trek_id_fkey"
            columns: ["trek_id"]
            isOneToOne: false
            referencedRelation: "trek_events"
            referencedColumns: ["trek_id"]
      ...
      subscriptions_billing: {
        Row: {
          ...
          renewal_status: Database["public"]["Enums"]["renewal_status"] | null
          start_date: string
    ...
    Enums: {
      event_creator_type: "internal" | "external"
      id_verification_status: "Pending" | "Verified" | "Rejected"
      payment_status: "Pending" | "Paid" | "Cancelled"
      post_type: "message_board" | "looking_for_trek"
      renewal_status: "active" | "expired"
      role_type: "trek_lead" | "medic" | "carry_list"
      subscription_type: "community" | "self_service"
      target_type: "trek" | "user"
