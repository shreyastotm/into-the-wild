      ...
      <CardContent>
        {recoveryChecked ? (
          showForm ? (
            ...
            <div className="text-center text-gray-600">Invalid or expired password reset link.</div>
          )
        ) : null}
      </CardContent>
      <CardFooter>
        <Button variant="link" className="w-full" onClick={() => navigate('/auth')}>Back to Sign In</Button>
      </CardFooter>
    </Card>
  );
}
