    ...
    <div className="min-h-screen">
      ...
      <section className="relative -mt-20 px-4 pb-12 z-10">
        <div className="grid grid-cols-3 gap-3 sm:gap-4 max-w-4xl mx-auto">
          <StatCard icon={<Mountain className="h-6 w-6 text-teal-600" />} value="50+" label="Treks" />
          <StatCard icon={<Users className="h-6 w-6 text-golden-600" />} value="1200+" label="Trekkers" />
          <StatCard icon={<Camera className="h-6 w-6 text-coral-600" />} value="5000+" label="Memories" />
        </div>
      </section>
    </div>
  );
