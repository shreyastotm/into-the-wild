    ...
    return (
      <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="relative min-h-screen flex flex-col items-center justify-center px-6 text-center">
          ...
          >
            Sign in to access your personal base camp, track your adventures,
            and plan your next trek
          </p>
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-golden-500 via-coral-500 to-teal-500 p-8 text-center shadow-2xl">
              ...
              <div className="relative">
                ...
                <p className="text-white/90 mb-6 max-w-md mx-auto">
                  Explore new trails, discover hidden gems, and create
...
const StatStation = ({
  ...
  const colorClasses = {
    golden:
      "from-golden-400 to-golden-600 text-golden-600 dark:text-golden-400",
  ...
  const bgClasses = {
    golden:
      "from-golden-100 to-golden-200 dark:from-golden-900/30 dark:to-golden-800/30",
    teal: "from-teal-100 to-teal-200 dark:from-teal-900/30 dark:to-teal-800/30",
    coral:
      "from-coral-100 to-coral-200 dark:from-coral-900/30 dark:to-coral-800/30",
  };
