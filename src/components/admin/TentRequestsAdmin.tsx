...
export const TentRequestsAdmin: React.FC<TentRequestsAdminProps> = ({
  eventId,
}) => {
  ...
  const [selectedRequest, setSelectedRequest] = useState<TentRequest | null>(
    null,
  );
  ...
  return (
    <div className="space-y-6" data-testid="tentrequestsadmin">
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              Review and approve or reject tent rental requests from
              participants.
            </p>
          </CardHeader>
          <CardContent>
              ...
              <TableBody>
                {processedRequests.map((request) => (
                  <TableRow key={request.id}>
                    ...
                    <TableCell>
                      <div className="text-sm" data-testid="tentrequestsadmin">
                        <div data-testid="tentrequestsadmin">
                          {request.quantity_requested} tent(s) ×{" "}
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          ...
          <div className="space-y-4" data-testid="tentrequestsadmin">
            <div data-testid="tentrequestsadmin">
