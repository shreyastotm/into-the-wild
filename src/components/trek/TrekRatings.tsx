...
export const TrekRatings: React.FC<TrekRatingsProps> = ({
  ...
  const [showParticipantRatingDialog, setShowParticipantRatingDialog] =
    useState(false);
  ...
  const handleParticipantRatingChange = (
    category: string,
    value: number | string,
  ) => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button onClick={() => setShowTrekRatingDialog(true)} size="sm">
        ...
        <Card>
          ...
          <CardFooter className="pt-0">
            <p className="text-xs text-muted-foreground">
              Based on {ratingSummary.totalRatings}{" "}
                ...
                {participants
                  ...
                  .map((participant) => {
                    ...
                    return (
                      <Card
                        key={participant.id}
                        className={isRated ? "border-green-100" : ""}
                      >
                        <CardHeader className="pb-2">
                        ...
                        <CardFooter>
                          <Button
                            onClick={() =>
                              openParticipantRatingDialog(participant.id)
                            }
                            size="sm"
      ...
      {/* Trek Rating Dialog */}
      <Dialog
        open={showTrekRatingDialog}
        onOpenChange={setShowTrekRatingDialog}
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {hasRated ? "Update Your Trek Rating" : "Rate This Trek"}
            </DialogTitle>
            <DialogDescription>
            ...
            <div className="space-y-4">
              <div>
                ...
                <RadioGroup
                  ...
                  onValueChange={(value) =>
                    handleTrekRatingChange("difficulty", parseInt(value))
                  }
                ...
                >
                  {[1, 2, 3, 4, 5].map((rating) => (
                    <div key={rating} className="flex flex-col items-center">
                      ...
                      >
                        <Star
                          className={`h-6 w-6 ${trekRatingForm.difficulty >= rating ? "fill-blue-600 text-blue-600" : "text-gray-300"}`}
                        />
                      </label>
              ...
              <div>
                ...
                <RadioGroup
                  ...
                  onValueChange={(value) =>
                    handleTrekRatingChange("enjoyment", parseInt(value))
                  }
                  className="flex justify-between mt-2"
                >
                  {[1, 2, 3, 4, 5].map((rating) => (
                    <div key={rating} className="flex flex-col items-center">
                      ...
                      >
                        <Star
                          className={`h-6 w-6 ${trekRatingForm.enjoyment >= rating ? "fill-red-600 text-red-600" : "text-gray-300"}`}
                        />
                      </label>
                      <span className="text-xs mt-1">{rating}</span>
                    </div>
              ...
              <div>
                ...
                <RadioGroup
                  ...
                  onValueChange={(value) =>
                    handleTrekRatingChange("scenic", parseInt(value))
                  }
                  className="flex justify-between mt-2"
                >
                  {[1, 2, 3, 4, 5].map((rating) => (
                    <div key={rating} className="flex flex-col items-center">
                      ...
                      >
                        <Star
                          className={`h-6 w-6 ${trekRatingForm.scenic >= rating ? "fill-green-600 text-green-600" : "text-gray-300"}`}
                        />
                      </label>
                      <span className="text-xs mt-1">{rating}</span>
                    </div>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSubmitTrekRating} disabled={submitting}>
              {submitting
                ? "Submitting..."
                : hasRated
                  ? "Update Rating"
      ...
      <Dialog
        open={showParticipantRatingDialog}
        onOpenChange={setShowParticipantRatingDialog}
      >
        <DialogContent>
          <DialogHeader>
            ...
            <div className="space-y-4">
              <div>
                ...
                <RadioGroup
                  ...
                  onValueChange={(value) =>
                    handleParticipantRatingChange("teamwork", parseInt(value))
                  }
                  className="flex justify-between mt-2"
                >
                  {[1, 2, 3, 4, 5].map((rating) => (
                    <div key={rating} className="flex flex-col items-center">
                      ...
                      >
                        <Star
                          className={`h-6 w-6 ${participantRatingForm.teamwork >= rating ? "fill-purple-600 text-purple-600" : "text-gray-300"}`}
                        />
                      </label>
                      <span className="text-xs mt-1">{rating}</span>
                    </div>
                ...
                >
                  {[1, 2, 3, 4, 5].map((rating) => (
                    <div key={rating} className="flex flex-col items-center">
                      ...
                      >
                        <Star
                          className={`h-6 w-6 ${participantRatingForm.punctuality >= rating ? "fill-amber-600 text-amber-600" : "text-gray-300"}`}
                        />
                      </label>
                      <span className="text-xs mt-1">{rating}</span>
                    </div>
                ...
                >
                  {[1, 2, 3, 4, 5].map((rating) => (
                    <div key={rating} className="flex flex-col items-center">
                      ...
                      >
                        <Star
                          className={`h-6 w-6 ${participantRatingForm.contribution >= rating ? "fill-teal-600 text-teal-600" : "text-gray-300"}`}
                        />
                      </label>
                      <span className="text-xs mt-1">{rating}</span>
                    </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    handleParticipantRatingChange("comments", e.target.value)
                  }
