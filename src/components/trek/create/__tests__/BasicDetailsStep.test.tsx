...
describe("BasicDetailsStep", () => {
  ...
  it("accepts and displays props correctly", () => {
    render(
      <BasicDetailsStep title="Test Title" data-testid="basicdetailsstep" />,
    );
    expect(screen.getByTestId("basicdetailsstep")).toHaveTextContent(
      "Test Title",
    );
  });
  ...
  it("handles user interactions", () => {
    ...
    render(
      <BasicDetailsStep onClick={handleClick} data-testid="basicdetailsstep" />,
    );
