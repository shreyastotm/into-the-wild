...
describe("PackingListStep", () => {
  ...
  it("accepts and displays props correctly", () => {
    render(
      <PackingListStep title="Test Title" data-testid="packingliststep" />,
    );
    expect(screen.getByTestId("packingliststep")).toHaveTextContent(
      "Test Title",
    );
  });
  ...
  it("handles user interactions", () => {
    ...
    render(
      <PackingListStep onClick={handleClick} data-testid="packingliststep" />,
    );
