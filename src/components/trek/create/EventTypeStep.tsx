  ...
  return (
    <div className="space-y-6">
      ...
      >
        <Card className="p-4 hover:shadow-md transition-shadow cursor-pointer">
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <Label htmlFor="trek" className="text-base font-medium cursor-pointer">
                🥾 Trek Event
              </Label>
              <p className="text-sm text-muted-foreground mt-1">
                Traditional hiking and trekking adventures. Perfect for outdoor enthusiasts looking for nature experiences.
              </p>
        ...
        <Card className="p-4 hover:shadow-md transition-shadow cursor-pointer">
          <div className="flex items-start space-x-3">
            <RadioGroupItem value={EventType.CAMPING} id="camping" className="mt-1" />
            <div className="flex-1">
              <Label htmlFor="camping" className="text-base font-medium cursor-pointer">
                🏕️ Camping Event
              </Label>
              <p className="text-sm text-muted-foreground mt-1">
                Comprehensive camping experiences with multiple activities, volunteers, and detailed planning.
              </p>
              <ul className="text-xs text-muted-foreground mt-2 space-y-1">
