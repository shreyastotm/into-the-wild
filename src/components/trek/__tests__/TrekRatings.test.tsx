...
describe("TrekRatings", () => {
  ...
  it("accepts and displays props correctly", () => {
    renderWithRouter(
      <TrekRatings title="Test Title" data-testid="trekratings" />,
    );
  ...
  it("handles user interactions", () => {
    ...
    renderWithRouter(
      <TrekRatings onClick={handleClick} data-testid="trekratings" />,
    );
  ...
  it("updates state correctly", async () => {
    ...
    fireEvent.click(screen.getByTestId("trekratings"));
    await waitFor(() => {
      expect(screen.getByTestId("trekratings")).toHaveTextContent(
