...
describe("UpcomingTreks", () => {
  ...
  it("accepts and displays props correctly", () => {
    renderWithRouter(
      <UpcomingTreks title="Test Title" data-testid="upcomingtreks" />,
    );
  ...
  it("handles user interactions", () => {
    ...
    renderWithRouter(
      <UpcomingTreks onClick={handleClick} data-testid="upcomingtreks" />,
    );
  ...
  it("updates state correctly", async () => {
    ...
    fireEvent.click(screen.getByTestId("upcomingtreks"));
    await waitFor(() => {
      expect(screen.getByTestId("upcomingtreks")).toHaveTextContent(
