...
describe("TrekCostsManager", () => {
  ...
  it("accepts and displays props correctly", () => {
    render(
      <TrekCostsManager title="Test Title" data-testid="trekcostsmanager" />,
    );
    expect(screen.getByTestId("trekcostsmanager")).toHaveTextContent(
      "Test Title",
    );
  });
  ...
  it("handles user interactions", () => {
    ...
    render(
      <TrekCostsManager onClick={handleClick} data-testid="trekcostsmanager" />,
    );
