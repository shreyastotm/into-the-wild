...
describe('IdVerification', () => {
  ...
  it('accepts and displays props correctly', () => {
    ...
    expect(screen.getByTestId('idverification')).toHaveTextContent('Test Title');
  });

  it('handles user interactions', () => {
    const handleClick = vi.fn();
    render(<IdVerification onClick={handleClick} data-testid="idverification" />);
  ...
  it('updates state correctly', async () => {
    ...
    fireEvent.click(screen.getByTestId('idverification'));
    await waitFor(() => {
      expect(screen.getByTestId('idverification')).toHaveTextContent(/updated|changed|new/i);
    });
  });
