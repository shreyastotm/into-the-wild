...
describe('UserImageUpload', () => {
  ...
  it('accepts and displays props correctly', () => {
    render(<UserImageUpload title="Test Title" data-testid="userimageupload" />);
    expect(screen.getByTestId('userimageupload')).toHaveTextContent('Test Title');
  });

  it('handles user interactions', () => {
    const handleClick = vi.fn();
    render(<UserImageUpload onClick={handleClick} data-testid="userimageupload" />);
  ...
  it('updates state correctly', async () => {
    ...
    fireEvent.click(screen.getByTestId('userimageupload'));
    await waitFor(() => {
      expect(screen.getByTestId('userimageupload')).toHaveTextContent(/updated|changed|new/i);
    });
  });
