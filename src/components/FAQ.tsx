...
const FAQ = () => {
  const faqData = [
    ...
    },
    {
      ...
      answer: "Transportation varies by trek. Some treks include pickup from designated points, while others require you to reach the starting point independently. Check the trek details for specific transportation information."
    },
    {
      question: "What is included in the trek cost?",
      answer: "The trek cost typically includes guide fees, basic safety equipment, and group activities. Food, transportation, and accommodation (for overnight treks) may or may not be included - check individual trek details for specifics."
    },
    {
      question: "Can I join a trek alone?",
      answer: "Absolutely! Many of our participants join as individuals. Our treks are designed to be social experiences where you can meet like-minded adventurers. Group sizes are kept small to ensure everyone gets to know each other."
    },
    {
      question: "What safety measures do you have?",
      answer: "All our treks are led by experienced and certified guides. We carry first aid kits, emergency communication devices, and follow established safety protocols. Guides are trained in wilderness first aid and emergency response."
    },
    {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Find answers to common questions about our treks, bookings, and what to expect on your adventure.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <Accordion type="single" collapsible className="space-y-4">
            {faqData.map((faq, index) => (
              <AccordionItem key={index} value={`item-${index}`} className="bg-white rounded-lg border px-6 py-2">
