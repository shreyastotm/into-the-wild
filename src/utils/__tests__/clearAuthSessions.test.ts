import { clearAllAuthSessions, hasPersistentAuthSession } from '../clearAuthSessions';
...
describe('clearAuthSessions', () => {
  ...
  describe('clearAllAuthSessions', () => {
    ...
    it('should clear all auth tokens from sessionStorage', () => {
      ...
      mockSessionStorage.setItem('regular-session-key', 'regular-session-value');
      ...
      // Check that regular keys are preserved
      expect(mockSessionStorage.getItem('regular-session-key')).toBe('regular-session-value');
    });
